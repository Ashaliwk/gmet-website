...
@section('main-container')
            ...
            <div class="container-fluid">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" action="/admin/shop-add" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input class="form-control" id="price" type="text" placeholder="Enter Price" name="price" value="{{old('price')}}"/>
                                @if ($errors->has('price'))
                                    <span class="text-danger">
                                        {{$errors->first('price')}}
                                    </span>
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid">
                                    <input class="btn btn-success btn-block" type="submit" value="Add Shop Product" name="submit">
                                </div>
                            </div>
                        </form>
                    </div>
