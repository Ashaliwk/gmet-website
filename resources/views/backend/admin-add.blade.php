...
@section('main-container')
            <div class="container-fluid"><br>
                <div class="card shadow mb-4">
                    <div class="card-header py-3"><a href="{{url('/admin/admins-list')}}" class="btn btn-success">Admins</a></div>
                    <div class="card-body">
                        <form method="post" action="{{$url}}">
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid">
                                <input class="btn btn-success btn-block" type="submit" value="Register an Admin" name="submit">
                            </div>
                        </form>
                    </div>
                </div>
